# Generated by Powerlevel10k configuration wizard on 2024-01-26 at 23:51 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    # Trimmed right prompt — only the segments we actually use.
    # See p10k's own list (or run `p10k configure`) for the full menu.
