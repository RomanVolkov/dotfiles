...
- Commit fixes: bash ${SKILL_DIR}/scripts/stage-and-commit.sh "fix: address code review findings" <changed-files>

STEP 5 - LOG PROGRESS (after commit):
Log details: echo "- confirmed: <list>
- false positives: <list>
- fixes: <what changed>
- validation: <what passed>" | bash ${SKILL_DIR}/scripts/append-progress.sh PROGRESS_FILE_PATH
